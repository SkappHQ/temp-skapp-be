...
public class DateTimeUtils {
	 ...
	 * @throws IllegalArgumentException If the dateTime or targetZoneId is null.
	 */
	public static LocalDateTime convertToTimeZone(LocalDateTime dateTime, ZoneId targetZoneId) {
		...
		if (targetZoneId == null) {
			throw new IllegalArgumentException("Target ZoneId cannot be null");
		}
	 ...
	 * @throws IllegalArgumentException If the dateTime or sourceZoneId is null.
	 */
	public static LocalDateTime convertToUtc(LocalDateTime dateTime, ZoneId sourceZoneId) {
		...
		if (sourceZoneId == null) {
			throw new IllegalArgumentException("Source ZoneId cannot be null");
		}
	 ...
	 * @throws IllegalArgumentException If the startDate is null.
	 */
	 ...
	 * @throws IllegalArgumentException if the day is not within the valid range (1-31).
	 */
	 ...
	 * @throws IllegalArgumentException If the time zone ID is null.
	 */
	public static boolean isValidTimeZone(String timeZone) {
		if (timeZone == null) {
			throw new IllegalArgumentException("Time zone ID cannot be null");
		}
	 ...
	 * @throws IllegalArgumentException if epochMillis is null.
	 */
	public static LocalTime epochMillisToUtcLocalTime(Long epochMillis) {
		if (epochMillis == null) {
			throw new IllegalArgumentException("Epoch milliseconds cannot be null");
		}
	 ...
	 * @throws IllegalArgumentException if epochDateTime is null.
	 */
