...
VALUES (default, 'TUESDAY', '[{"hours": 4.0, "timeBlock": "MORNING_HOURS"},{"hours": 4.0, "timeBlock": "EVENING_HOURS"}]', 8.0, false, 8, 30),
       (default, 'MONDAY', '[{"hours": 4.0, "timeBlock": "MORNING_HOURS"},{"hours": 4.0, "timeBlock": "EVENING_HOURS"}]', 8.0, true, 8, 30),
       (default, 'WEDNESDAY', '[{"hours": 4.0, "timeBlock": "MORNING_HOURS"},{"hours": 4.0, "timeBlock": "EVENING_HOURS"}]', 8.0, false, 8, 30),
       (default, 'FRIDAY', '[{"hours": 4.0, "timeBlock": "MORNING_HOURS"},{"hours": 4.0, "timeBlock": "EVENING_HOURS"}]', 8.0, false, 8, 30),
       (default, 'THURSDAY', '[{"hours": 4.0, "timeBlock": "MORNING_HOURS"},{"hours": 4.0, "timeBlock": "EVENING_HOURS"}]', 8.0, false, 8, 30),
       (default, 'SATURDAY', '[{"hours": 4.0, "timeBlock": "MORNING_HOURS"},{"hours": 4.0, "timeBlock": "EVENING_HOURS"}]', 8.0, false, 8, 30),
       (default, 'SUNDAY', '[{"hours": 4.0, "timeBlock": "MORNING_HOURS"},{"hours": 4.0, "timeBlock": "EVENING_HOURS"}]', 8.0, false, 8, 30);

INSERT INTO `time_record`(time_record_id, created_by, created_date, last_modified_by, last_modified_date, date, day_of_week,
                          clock_in_time, clock_out_time, is_manual, worked_hours, break_hours, leave_hours, employee_id, is_completed)
VALUES (default, '1402452a-39c0-4a8d-a50d-3e4bfa71a15d', CURRENT_TIMESTAMP,
        ...
        CURRENT_TIMESTAMP, 'MONDAY', 1708912800000, 1708948800000, false, 6.5, 3.5, 0, 1, true), -- 2024-2-26 7:30 - 5:30
...
INSERT INTO time_request (time_request_id, requested_start_time, requested_end_time, initial_clock_in,
                         initial_clock_out,
                         work_hours, break_hours, status, request_type, time_record_id, employee_id, reviewer_id, reviewed_at, created_date)
VALUES
   (default, 1708939800000, 1708943400000, 0, 0, 7.5, 2.5, 'PENDING', 'MANUAL_ENTRY_REQUEST', 1, 1, null, null, CURRENT_TIMESTAMP), -- 2024-2-26 3pm - 4pm
   (default, 1709006400000, 1708992000000, 0, 0, 0, 1,'PENDING', 'EDIT_RECORD_REQUEST', 1, 1, null, null, CURRENT_TIMESTAMP); -- 2024-2-26 3pm - 4pm
...
INSERT INTO leave_type (type_id, name, emoji_code, color_code, calculation_type, min_duration, is_attachment, is_overridden,
                        is_attachment_must, is_comment_must, is_auto_approval, is_active, carry_forward_enabled, max_carry_forward_days, carry_forward_expiration_days, is_carry_forward_remaining_balance_enabled)
VALUES (default, 'Study', 'U+1F600', '#FF0000', 'ACCUMULATED', 'FULL_DAY', false, false, false, false, false, true, false, 0.0, 0.0, false),
       (default, 'Casual', 'U+1F601', '#FF0001', 'ACCUMULATED', 'FULL_DAY', false, false, false, false, false, true, false, 0.0, 0.0, false),
       (default, 'Medical', 'U+1F602', '#FF0002', 'ACCUMULATED', 'FULL_DAY', false, false, false, false, false, true, false, 0.0, 0.0, false),
       (default, 'Maternity', 'U+1F603', '#FF0003', 'ACCUMULATED', 'FULL_DAY', false, false, false, false, false, true, false, 0.0, 0.0, false),
       (default, 'Academic', 'U+1F604', '#FF0004', 'ACCUMULATED', 'FULL_DAY', false, false, false, false, false, true, false, 0.0, 0.0, false),
       (default, 'Religious', 'U+1F604', '#FF0004', 'ACCUMULATED', 'HALF_DAY', false, false, false, true, false, true, false, 0.0, 0.0, false);
